...
define(["require", "deepjs/deep"], function(require, deep) {
	...
	var api = {
		...
		validate: function(map, schema, inputHandler) {
			return this.after(function(renderNoden, node) {
				if (!deep.ui.form || deep.ui.form.validate) {
					deep.warn("you should load 'deep-views/lib/validation' before using .validate on dom-composer. skipping call.");
					return;
				}
				return deep.ui.form.validate(node || renderNode, map, schema, inputHandler);
			});
		}
	};
